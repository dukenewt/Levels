...
class EnhancedGameExperienceManager {
  static final EnhancedGameExperienceManager _instance =
  ...
  void initialize(BuildContext context) {
    ...
    debugPrint(
        '🎮 Enhanced GameExperienceManager: Successfully initialized at level $_lastLevel');
  }
  ...
  void _handleLevelUp(int oldLevel, int newLevel) {
    debugPrint(
        '🎮 Ring celebration triggered! $oldLevel -> $newLevel (last progress: $_lastXPProgress)');
